<div class="modal fade" id="kt_modal_new_facility_category" tabindex="-1" aria-hidden="true" style="direction: ltr">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_facility_category_form" class="form" enctype="multipart/form-data"
                    action="{{ route('facilitiesCategory.store') }}" method="POST">
                    @csrf
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{ trans('backend.Add_Facility_Category') }}</h1>
                        <!--end::Title-->
