<div class="modal fade" id="kt_modal_edit_facility_category{{ $category->id }}" tabindex="-1" aria-hidden="true"
    style="direction: ltr">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kt_modal_new_facility_category_form" class="form" enctype="multipart/form-data"
                    action="{{ route('facilitiesCategory.update', $category->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{ trans('backend.Edit_Facility_Category') }}</h1>
                        <!--end::Title-->
                    ...
                    <div class="text-center">
                        <button type="reset" id="kt_modal_new_facility_category_cancel" data-bs-dismiss="modal"
                            class="btn btn-light me-3">{{ trans('backend.Cancel') }}</button>
                        <button type="submit" id="kt_modal_new_facility_category_submit" class="btn btn-primary">
