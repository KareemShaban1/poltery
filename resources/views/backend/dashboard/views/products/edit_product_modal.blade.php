<div class="modal fade" id="kt_modal_edit_product{{ $product->id }}" tabindex="-1" aria-hidden="true"
    style="direction: ltr">
    <!--begin::Modal dialog-->
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row col-md-6">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Enter English Title" name="name_en" value="{{ $product->name_en }}" />
                        </div>
                        ...
                        <div class="d-flex flex-column mb-8 fv-row col-md-6">
                            ...
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Enter Arabic Tit;e" name="name_ar" value="{{ $product->name_ar }}" />
                        </div>
                    </div>
