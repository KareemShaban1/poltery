<div class="modal fade" id="kt_modal_new_recipe_type" tabindex="-1" aria-hidden="true" style="direction: ltr">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_recipe_type_form" class="form" enctype="multipart/form-data"
                    action="{{ route('recipeTypes.store') }}" method="POST">
                    @csrf
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{ trans('backend.Add_Recipe_Type') }}</h1>
                        <!--end::Title-->
