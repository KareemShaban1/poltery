<div class="modal fade" id="kt_modal_new_sponsor" tabindex="-1" aria-hidden="true" style="direction: ltr">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_new_sponsor_form" class="form" enctype="multipart/form-data"
                    action="{{ route('sponsors.store') }}" method="POST">
                    @csrf
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">{{ trans('backend.Add_Sponsor') }}</h1>
                        <!--end::Title-->
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row col-md-6">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                    title="Specify a sponsor english title"></i>
                            </label>
                        ...
                        <div class="d-flex flex-column mb-8 fv-row col-md-6">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                    title="Specify a sponsor arabic title "></i>
                            </label>
